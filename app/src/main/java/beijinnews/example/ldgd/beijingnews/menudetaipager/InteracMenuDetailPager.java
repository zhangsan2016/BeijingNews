...
import beijinnews.example.ldgd.beijingnews.utils.BitmapCacheUtils;
...
import beijinnews.example.ldgd.beijingnews.utils.NetCacheUtils;
...
public class InteracMenuDetailPager extends MenuDetaiBasePager {
    ...
    public InteracMenuDetailPager(Context context, NewCenterPagerBase.DataBean detailPagerData) {
        super(context);
